...
public class DatabaseAccess_ViewTicket extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		try {
			...
			while (rs2.next()) {
				//Retrieve by column name
				String curr_date = rs2.getString("ticket_date");
