...
public class ViewOdServlet2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            sql = "Select id,od_date from od where status='Applied'";
            ...
            while (rs.next()) {
                ...
                sto = conn.prepareStatement("UPDATE od SET status = ? WHERE id = ? AND od_date = ?");
